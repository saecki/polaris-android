...
public class ServerAPI implements IRemoteAPI {
    ...
    static private String serverPortKey;
    ...
    public ServerAPI(Context context) {
        ...
        serverAddressKey = context.getString(R.string.pref_key_server_address);
        serverPortKey = context.getString(R.string.pref_key_server_port);
    ...
    static String getAPIRootURL() {
        String address = preferences.getString(serverAddressKey, "").trim();
        String port = preferences.getString(serverPortKey, "").trim();
